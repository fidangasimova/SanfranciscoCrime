...
# Final Logistic regression with more than one predictor on Validation (test) and sf_crime_p
...
Another method will be applied to improve the results of prediction. PCA is is one of ML methods to reduce high-dimensionality of the data set in case of many correlated predictors. PCA works best with numerical data all categorical variables are excluded from predictors..
...
## Results
#  As the correlation shows predictors are  correlated, so PCA analysis would  be appropriate method
##Discussion
